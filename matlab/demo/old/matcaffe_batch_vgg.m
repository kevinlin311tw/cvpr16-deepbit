function [Kevin64_scores ,Kevin64_list_im] = matcaffe_batch_vgg(y_ft_list_im, use_gpu)
...
for bb = 1 : num_batches
    ...
    tic
    input_data = prepare_batch_vgg(y_ft_list_im(range),IMAGE_MEAN,batch_size);
    toc, tic
...
toc(initic);
Kevin64_list_im = y_ft_list_im;
Kevin64_scores = y_ft_scores;
%if exist('filename', 'var')
%    save([filename '_KevinCIFAR64.probs.mat'],'KevinCIFAR64_list_im','KevinCIFAR64_scores','-v7.3');
%end
